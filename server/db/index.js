...
const randomCaseForEachLetter = (word)=> {
  return(word.split('').map(letter=> getRandom(2) === 0 ? letter.toUpperCase() : letter.toLowerCase()).join('')) 
}
...
Choice.createRandom = function () {
  return Choice.create({
    choiceA: insertInRandomSpot(faker.lorem.words(getRandom(5)), randomCaseForEachLetter("calculus")),
    choiceB: insertInRandomSpot(faker.lorem.words(getRandom(5)), randomCaseForEachLetter("calculus")),
    choiceC: insertInRandomSpot(faker.lorem.words(getRandom(5)), randomCaseForEachLetter("calculus")),
  });
};
